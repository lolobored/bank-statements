...
public class CommBankTransactionsPage {
    ...
    private static final By OLD_ADVANCED_BUTTON = By.xpath("//*[@id=\"cba_advanced_search_trigger\"]/i");
    ...
    private static final By OLD_EXPORT_BUTTON   = By.xpath("//*[@id=\"ctl00_CustomFooterContentPlaceHolder_updatePanelExport1\"]/div/a");
    private static final By OLD_EXPORT_FORMAT   = By.id("ctl00_CustomFooterContentPlaceHolder_ddlExportType1_field");
    private static final By OLD_EXPORT_ACTION   = By.id("ctl00_CustomFooterContentPlaceHolder_lbExport1");
    ...
    private void downloadOldLayout() throws InterruptedException {
        ...
        ((JavascriptExecutor) driver).executeScript("arguments[0].scrollIntoView(true);", advancedButton);
