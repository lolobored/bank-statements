...
public class MetroAccountsPage {
    ...
    private static final By ACCOUNT_HEADERS = By.xpath(
            "/html/body/form[1]/div[4]/div[3]/div[1]/div[2]/div[1]/div[1]/div/div[2]/div/div/div/div[1]/header");
    private static final By ACCOUNT_NUMBER  = By.xpath("div[2]/div/div[2]/div[1]/div[2]/div/div/div[3]/div/span");
    private static final By ACCOUNT_ICON    = By.xpath("div[1]/div/div/div/div/span");
    private static final By ACCOUNT_LINK    = By.xpath("div[2]/div/div[1]/div[1]/div[1]/div[1]/div/div/div[1]/div/a");
    ...
    public List<MetroAccountInfo> collectAccounts() {
        ...
        for (WebElement header : driver.findElements(ACCOUNT_HEADERS)) {
            ...
            String accountType = "C".equals(header.findElement(ACCOUNT_ICON).getAttribute("data-icon"))
