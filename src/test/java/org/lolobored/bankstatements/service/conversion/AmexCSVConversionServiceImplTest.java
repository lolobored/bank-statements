...
class AmexCSVConversionServiceImplTest {
    ...
    void convertsDebitTransaction() throws ParseException {
        String csv = "Date,Description,Amount,Extended Details,Appears On Your Statement As,Address,Town/City,Postcode,Country,Reference\n" +
    ...
    void convertsCreditTransaction() throws ParseException {
        ...
        assertThat(tx.getDate()).isEqualTo(DATE_FORMAT.parse("15/03/2024"));
    }
